...
const Mejor_Projects: React.FC<Props> = ({ searchdata }) => {
  ...
  const GeneralProjects = GeneralAndMejorProjects?.filter(
    (item: any) => item.projectType == "general"
  );
  const Projects = GeneralProjects?.filter((item: any) => {
